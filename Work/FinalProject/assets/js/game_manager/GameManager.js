  ...
  setupEventListener() {
    this.scene.events.on('pickUpChest', (chestId, playerId) => {
      ...
      if (this.chests[chestId]) {
        ...
        // give the player one health for picking up chest, unless they are at max health
        if (this.players[playerId].health < 10 ) {
          this.players[playerId].health = parseInt(this.players[playerId].health);
          this.players[playerId].updateHealth(1);
          this.scene.events.emit('updatePlayerHealth', playerId, this.players[playerId].health);
          console.log(this.players[playerId].health);
        }
      ...
      if (this.monsters[monsterId]) {
        ...
        if (this.monsters[monsterId].health <= 0) {
          ...
          if (this.players[playerId].health <= 0) {
            ...
            this.players[playerId].updateGold(parseInt(-this.players[playerId].gold), 10);
            this.scene.events.emit('updateScore', this.players[playerId].gold);
            ...
            // end game 
            this.scene.events.emit('endGame', this.players[playerId].gold);
          }
        }
      }
    });
